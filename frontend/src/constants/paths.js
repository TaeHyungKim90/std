...
export const ROUTE_SEGMENTS = {
	...
	ADMIN: {
		...
		DEPARTMENTS: PATHS.ADMIN_DEPARTMENTS.slice(ADMIN.length + 1),
		HOLIDAYS: PATHS.ADMIN_HOLIDAYS.slice(ADMIN.length + 1),
		POSITIONS: PATHS.ADMIN_POSITIONS.slice(ADMIN.length + 1),
		WORK_LOCATIONS: PATHS.ADMIN_WORK_LOCATIONS.slice(ADMIN.length + 1),
		ATTENDANCE: PATHS.ADMIN_ATTENDANCE.slice(ADMIN.length + 1),
		ATTENDANCE_REWARDS: PATHS.ADMIN_ATTENDANCE_REWARDS.slice(ADMIN.length + 1),
		USERS: PATHS.ADMIN_USERS.slice(ADMIN.length + 1),
		RECRUITMENT: PATHS.ADMIN_RECRUITMENT.slice(ADMIN.length + 1),
		RESUME_TEMPLATES: PATHS.ADMIN_RESUME_TEMPLATES.slice(ADMIN.length + 1),
