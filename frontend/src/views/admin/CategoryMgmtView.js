...
const CategoryMgmtView = () => {
    ...
    const fetchCategories = async () => {
        try {
            setLoading(true);
            const res = await adminService.getCategoryTypes();
    ...
    const handleCreate = async () => {
        ...
        try {
            await adminService.createCategoryType(newCat);
    ...
    const handleUpdate = async (id) => {
        try {
            ...
            await adminService.updateCategoryType(id, updateData);
            setEditingId(null);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await adminService.deleteCategoryType(id);
            fetchCategories();
